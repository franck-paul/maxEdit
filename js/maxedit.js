...
const inMax = (elt) => {
  ...
  $(elt.toolbar)
    ...
    .css('background-image', 'url(index.php?pf=maxEdit/img/max-off.svg)');
...
const outMax = (elt) => {
  ...
  $(elt.toolbar)
    ...
    .css('background-image', 'url(index.php?pf=maxEdit/img/max-on.svg)');
...
jsToolBar.prototype.elements.maxEdit.icon = 'index.php?pf=maxEdit/img/max-on.svg';
